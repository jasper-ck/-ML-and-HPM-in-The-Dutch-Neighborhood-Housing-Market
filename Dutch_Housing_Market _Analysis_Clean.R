...
# make copy with depedent variable for statistical tests 
combi_ds_tr_tst_copy1 <- combi_ds_tr_tst[1:88] 
combi_ds_tr_tst_copy1$gemiddelde_woningwaarde_35 <- combi_ds_tr_tst$gemiddelde_woningwaarde_35 

# Correlation plot 
# source: http://www.sthda.com/upload/rquery_cormat.r

cor(combi_ds_tr_tst_copy1, method = c("spearman"))
corrplot(cor(combi_ds_tr_tst_copy1 ))
...
# KMO scores 
kmo(combi_ds_tr_tst_copy1)

# Bartlett's Test
nieuw <- combi_ds_tr_tst_copy1  %>% 
  pivot_longer(cols = 4:ncol(combi_ds_tr_tst_copy1), names_to = 'group', 
               values_to = 'value')
...
# set up right dataframe
train_combined_ready <- train_combined_ready_MINREM 
test_combined_ready_copy <- test_combined_ready[1:85]
test_combined_ready_copy$gemiddelde_woningwaarde_35 <- test_combined_ready$gemiddelde_woningwaarde_35
test_combined_ready <- test_combined_ready_copy
